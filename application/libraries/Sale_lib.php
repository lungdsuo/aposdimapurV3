...
class Sale_lib
{
	...
	public function get_item_discount($quantity, $price, $discount_percentage)
	 {                   /* code by Mozhui. makes discount to round figure*/
		//$total = bcmul($quantity, $price);
	       //	$discount_fraction = bcdiv($discount_percentage, 100);

		//return round(bcmul($total, $discount_fraction), totals_decimals(), PHP_ROUND_HALF_UP)sssssssssss;
           return $discount_percentage * $quantity;
	}
